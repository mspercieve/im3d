...
class Trainer(BaseTrainer):
    ...
    def eval_step(self, data):
        ...
        :return:
        '''
        loss = self.compute_loss(data, train=False)
    ...
    def to_device(self, data):
        ...
        if self.cfg.config[self.cfg.config['mode']]['phase'] in ['joint']:
            ...
            bdb2D_pos_resize = data['boxes_batch']['bdb2D_pos_resize'].int().to(device)
            ...
            joint_input = {'bdb3D':bdb3D, 'K':K, 'depth_maps':depth_maps, 'cam_R_gt':cam_R_gt,
                           ...
                           'bdb2D_from_3D_gt':bdb2D_from_3D_gt, 'bdb2D_pos':bdb2D_pos, 'bdb2D_pos_resize':bdb2D_pos_resize}
    ...
    def compute_loss(self, data, train=True):
        ...
        '''computer losses'''
        loss = self.net.loss(est_data, data, train)
        return loss
