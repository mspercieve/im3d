...
class SUNRGBD_DATA(object):
    ...
    def __init__(self, K, R, scene_types, rgb_img, depth_map, layout_3D, sample_id, room_name, instance_data,
                 world_R_inv=None, lo_inv=None, bdb3d_inv=None):
        self.__cam_K = K
        self.__cam_R = R
        ...
        self.__world_R_inv = world_R_inv
        self.__lo_inv = lo_inv
        self.__bdb3d_inv = bdb3d_inv
    ...
    @property
    def world_R_inv(self):
        return self.__world_R_inv

    @property
    def lo_inv(self):
        return self.__lo_inv

    @property
    def bdb3d_inv(self):
        return self.__bdb3d_inv
