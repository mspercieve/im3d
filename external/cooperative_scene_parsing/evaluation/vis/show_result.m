...
save_root = 'D:\PycharmProjects\SceneUnderstanding\Implicit3DUnderstanding-main\out\total3d\20110611514267\matlab_output';
paths = {
    {fullfile(save_root, 'ours_coop'), ...
    'D:\PycharmProjects\SceneUnderstanding\Implicit3DUnderstanding-main\out\total3d\20110611514267\visualization'}, ...
...
if exist('search_folder', 'var')
    ...
    imageIds= double(1):double(10335)
end
